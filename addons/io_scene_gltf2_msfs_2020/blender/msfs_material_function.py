...
class MSFS2020_Material:
    ...
    def createNodetree(self):
        ...
        nodeglTFSettings.inputs[0].default_value = 1.000
    ...
    def defaultShadersTree(self):
        ...
        ## Links
        self.link(
            subtractDetailOMR.outputs[0], clampDetailOMR.inputs[6]
        )  ## input[6] == "Vector"
    ...
    def updateNormalLinks(self):
        ...
        self.link(
            nodeDetailNormalScale.outputs[0], nodeDetailNormalMapSampler.inputs[0]
        )
    ...
    def get_or_create_group_by_name(self, group_name: str):
        """
